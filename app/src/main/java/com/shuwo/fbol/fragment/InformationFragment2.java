...
import com.shuwo.fbol.adapter.Info2Adapter;
...
public class InformationFragment2 extends BaseFragment implements IBaseView,SwipeRefreshLayout.OnRefreshListener,BaseQuickAdapter.RequestLoadMoreListener{
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
    ...
    private void initAdapter() {
        adapter = new Info2Adapter(R.layout.img_two_text_top_and_text_button, beanList);
